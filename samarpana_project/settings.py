"""
Django settings for samarpana_project project.
...
SECRET_KEY = 'django-insecure-(73k20$r=ow6j*k*klvu9ip_5)knnuofhdcn2-@((@ugg5b^d+'
...
STATICFILES_DIRS = [
    BASE_DIR /'ticketing'/'static',  # Adjust if your static folder is elsewhere
]
...
# Redirect to organiser dashboard after successful login
